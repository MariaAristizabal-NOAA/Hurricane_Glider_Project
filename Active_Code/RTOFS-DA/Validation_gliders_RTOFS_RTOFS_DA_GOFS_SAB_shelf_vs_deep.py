...
#date_ini = '2020/07/19/06'
#date_end = '2020/07/22/06'
...
DF_RTOFS_temp_salt_deep = pd.DataFrame()
DF_RTOFS_DA_temp_salt_deep = pd.DataFrame()
DF_GOFS_temp_salt_deep = pd.DataFrame()
DF_RTOFS_MLD_deep = pd.DataFrame()
DF_RTOFS_DA_MLD_deep = pd.DataFrame()
DF_GOFS_MLD_deep = pd.DataFrame()
DF_RTOFS_OHC_deep = pd.DataFrame()
DF_RTOFS_DA_OHC_deep = pd.DataFrame()
DF_GOFS_OHC_deep = pd.DataFrame()
DF_RTOFS_T100_deep = pd.DataFrame()
DF_RTOFS_DA_T100_deep = pd.DataFrame()
DF_GOFS_T100_deep = pd.DataFrame()
DF_RTOFS_T100_300_deep = pd.DataFrame()
DF_RTOFS_DA_T100_300_deep = pd.DataFrame()
DF_GOFS_T100_300_deep = pd.DataFrame()
DF_RTOFS_PEA_deep = pd.DataFrame()
DF_RTOFS_DA_PEA_deep = pd.DataFrame()
DF_GOFS_PEA_deep = pd.DataFrame()
...
for f,dataset_id in enumerate(gliders):
    ...
    if not empty_dataset:
        ...
        if np.logical_or.reduce([dataset_id.split('-')[0]=='pelagia',\
                                 dataset_id.split('-')[0]=='sam',\
                                 dataset_id.split('-')[0]=='franklin',\
                                 dataset_id.split('-')[0][0:2]=='ng']):
        ...
        if dataset_id.split('-')[0][0:2]=='sp':
            print('Deep glider: '+dataset_id)
            #%% Concatenate data frames
            DF_RTOFS_temp_salt_deep = pd.concat([DF_RTOFS_temp_salt_deep, df_RTOFS_temp_salt])
            DF_RTOFS_DA_temp_salt_deep = pd.concat([DF_RTOFS_DA_temp_salt_deep, df_RTOFS_DA_temp_salt])
            DF_GOFS_temp_salt_deep = pd.concat([DF_GOFS_temp_salt_deep, df_GOFS_temp_salt])
            DF_RTOFS_MLD_deep = pd.concat([DF_RTOFS_MLD_deep, df_RTOFS_MLD])
            DF_RTOFS_DA_MLD_deep = pd.concat([DF_RTOFS_DA_MLD_deep, df_RTOFS_DA_MLD])
            DF_GOFS_MLD_deep = pd.concat([DF_GOFS_MLD_deep, df_GOFS_MLD])
            DF_RTOFS_OHC_deep = pd.concat([DF_RTOFS_OHC_deep, df_RTOFS_OHC])
            DF_RTOFS_DA_OHC_deep = pd.concat([DF_RTOFS_DA_OHC_deep, df_RTOFS_DA_OHC])
            DF_GOFS_OHC_deep = pd.concat([DF_GOFS_OHC_deep, df_GOFS_OHC])
            DF_RTOFS_T100_deep = pd.concat([DF_RTOFS_T100_deep, df_RTOFS_T100])
            DF_RTOFS_DA_T100_deep = pd.concat([DF_RTOFS_DA_T100_deep, df_RTOFS_DA_T100])
            DF_GOFS_T100_deep = pd.concat([DF_GOFS_T100_deep, df_GOFS_T100])
            DF_RTOFS_T100_300_deep = pd.concat([DF_RTOFS_T100_300_deep, df_RTOFS_T100_300])
            DF_RTOFS_DA_T100_300_deep = pd.concat([DF_RTOFS_DA_T100_300_deep, df_RTOFS_DA_T100_300])
            DF_GOFS_T100_300_deep = pd.concat([DF_GOFS_T100_300_deep, df_GOFS_T100_300])
            DF_RTOFS_DA_PEA_deep = pd.concat([DF_RTOFS_DA_PEA_deep, df_RTOFS_DA_PEA])
            DF_GOFS_PEA_deep = pd.concat([DF_GOFS_PEA_deep, df_GOFS_PEA])

#%% Save all data frames
DF_RTOFS_temp_salt_shelf.to_pickle('DF_RTOFS_temp_salt_SAB_shelf.pkl')
DF_RTOFS_MLD_shelf.to_pickle('DF_RTOFS_MLD_SAB_shelf.pkl')
DF_RTOFS_OHC_shelf.to_pickle('DF_RTOFS_OHC_SAB_shelf.pkl')
DF_RTOFS_T100_shelf.to_pickle('DF_RTOFS_T100_SAB_shelf.pkl')
DF_RTOFS_T100_300_shelf.to_pickle('DF_RTOFS_T100_300_SAB_shelf.pkl')
DF_RTOFS_PEA_shelf.to_pickle('DF_RTOFS_PEA_SAB_shelf.pkl')

DF_RTOFS_DA_temp_salt_shelf.to_pickle('DF_RTOFS_DA_temp_salt_SAB_shelf.pkl')
DF_RTOFS_DA_MLD_shelf.to_pickle('DF_RTOFS_DA_MLD_SAB_shelf.pkl')
DF_RTOFS_DA_OHC_shelf.to_pickle('DF_RTOFS_DA_OHC_SAB_shelf.pkl')
DF_RTOFS_DA_T100_shelf.to_pickle('DF_RTOFS_DA_T100_SAB_shelf.pkl')
DF_RTOFS_DA_T100_300_shelf.to_pickle('DF_RTOFS_DA_T100_300_SAB_shelf.pkl')
DF_RTOFS_DA_PEA_shelf.to_pickle('DF_RTOFS_DA_PEA_SAB_shelf.pkl')

DF_GOFS_temp_salt_shelf.to_pickle('DF_GOFS_temp_salt_SAB_shelf.pkl')
DF_GOFS_MLD_shelf.to_pickle('DF_GOFS_MLD_SAB_shelf.pkl')
DF_GOFS_OHC_shelf.to_pickle('DF_GOFS_OHC_SAB_shelf.pkl')
DF_GOFS_T100_shelf.to_pickle('DF_GOFS_T100_SAB_shelf.pkl')
DF_GOFS_T100_300_shelf.to_pickle('DF_GOFS_T100_300_SAB_shelf.pkl')
DF_GOFS_PEA_shelf.to_pickle('DF_GOFS_PEA_SAB_shelf.pkl')

#%% Save all data frames
DF_RTOFS_temp_salt_deep.to_pickle('DF_RTOFS_temp_salt_SAB_deep.pkl')
DF_RTOFS_MLD_deep.to_pickle('DF_RTOFS_MLD_SAB_deep.pkl')
DF_RTOFS_OHC_deep.to_pickle('DF_RTOFS_OHC_SAB_deep.pkl')
DF_RTOFS_T100_deep.to_pickle('DF_RTOFS_T100_SAB_deep.pkl')
DF_RTOFS_T100_300_deep.to_pickle('DF_RTOFS_T100_300_SAB_deep.pkl')
DF_RTOFS_PEA_deep.to_pickle('DF_RTOFS_PEA_SAB_deep.pkl')

DF_RTOFS_DA_temp_salt_deep.to_pickle('DF_RTOFS_DA_temp_salt_SAB_deep.pkl')
DF_RTOFS_DA_MLD_deep.to_pickle('DF_RTOFS_DA_MLD_SAB_deep.pkl')
DF_RTOFS_DA_OHC_deep.to_pickle('DF_RTOFS_DA_OHC_SAB_deep.pkl')
DF_RTOFS_DA_T100_deep.to_pickle('DF_RTOFS_DA_T100_SAB_deep.pkl')
DF_RTOFS_DA_T100_300_deep.to_pickle('DF_RTOFS_DA_T100_300_SAB_deep.pkl')
DF_RTOFS_DA_PEA_deep.to_pickle('DF_RTOFS_DA_PEA_SAB_deep.pkl')

DF_GOFS_temp_salt_deep.to_pickle('DF_GOFS_temp_salt_SAB_deep.pkl')
DF_GOFS_MLD_deep.to_pickle('DF_GOFS_MLD_SAB_deep.pkl')
DF_GOFS_OHC_deep.to_pickle('DF_GOFS_OHC_SAB_deep.pkl')
DF_GOFS_T100_deep.to_pickle('DF_GOFS_T100_SAB_deep.pkl')
DF_GOFS_T100_300_deep.to_pickle('DF_GOFS_T100_300_SAB_deep.pkl')
DF_GOFS_PEA_deep.to_pickle('DF_GOFS_PEA_SAB_deep.pkl')


#%% Load all data frames
'''
DF_RTOFS_temp_salt_shelf = pd.read_pickle('DF_RTOFS_temp_salt_SAB_shelf.pkl')
DF_RTOFS_MLD_shelf = pd.read_pickle('DF_RTOFS_MLD_SAB_shelf.pkl')
DF_RTOFS_OHC_shelf = pd.read_pickle('DF_RTOFS_OHC_SAB_shelf.pkl')
DF_RTOFS_T100_shelf = pd.read_pickle('DF_RTOFS_T100_SAB_shelf.pkl')
DF_RTOFS_T100_300_shelf = pd.read_pickle('DF_RTOFS_T100_300_SAB_shelf.pkl')
DF_RTOFS_PEA_shelf = pd.read_pickle('DF_RTOFS_PEA_SAB_shelf.pkl')

DF_RTOFS_DA_temp_salt_shelf = pd.read_pickle('DF_RTOFS_DA_temp_salt_SAB_shelf.pkl')
DF_RTOFS_DA_MLD_shelf = pd.read_pickle('DF_RTOFS_DA_MLD_SAB_shelf.pkl')
DF_RTOFS_DA_OHC_shelf = pd.read_pickle('DF_RTOFS_DA_OHC_SAB_shelf.pkl')
DF_RTOFS_DA_T100_shelf = pd.read_pickle('DF_RTOFS_DA_T100_SAB_shelf.pkl')
DF_RTOFS_DA_T100_300_shelf = pd.read_pickle('DF_RTOFS_DA_T100_300_SAB_shelf.pkl')
DF_RTOFS_DA_PEA_shelf = pd.read_pickle('DF_RTOFS_DA_PEA_SAB_shelf.pkl')

DF_GOFS_temp_salt_shelf = pd.read_pickle('DF_GOFS_temp_salt_SAB_shelf.pkl')
DF_GOFS_MLD_shelf = pd.read_pickle('DF_GOFS_MLD_SAB_shelf.pkl')
DF_GOFS_OHC_shelf = pd.read_pickle('DF_GOFS_OHC_SAB_shelf.pkl')
DF_GOFS_T100_shelf = pd.read_pickle('DF_GOFS_T100_SAB_shelf.pkl')
DF_GOFS_T100_300_shelf = pd.read_pickle('DF_GOFS_T100_300_SAB_shelf.pkl')
DF_GOFS_PEA_shelf = pd.read_pickle('DF_GOFS_PEA_SAB_shelf.pkl')

#%%%%
DF_RTOFS_temp_salt_deep = pd.read_pickle('DF_RTOFS_temp_salt_SAB_deep.pkl')
DF_RTOFS_MLD_deep = pd.read_pickle('DF_RTOFS_MLD_SAB_deep.pkl')
DF_RTOFS_OHC_deep = pd.read_pickle('DF_RTOFS_OHC_SAB_deep.pkl')
DF_RTOFS_T100_deep = pd.read_pickle('DF_RTOFS_T100_SAB_deep.pkl')
DF_RTOFS_T100_300_deep = pd.read_pickle('DF_RTOFS_T100_300_SAB_deep.pkl')
DF_RTOFS_PEA_deep = pd.read_pickle('DF_RTOFS_PEA_SAB_deep.pkl')

DF_RTOFS_DA_temp_salt_deep = pd.read_pickle('DF_RTOFS_DA_temp_salt_SAB_deep.pkl')
DF_RTOFS_DA_MLD_deep = pd.read_pickle('DF_RTOFS_DA_MLD_SAB_deep.pkl')
DF_RTOFS_DA_OHC_deep = pd.read_pickle('DF_RTOFS_DA_OHC_SAB_deep.pkl')
DF_RTOFS_DA_T100_deep = pd.read_pickle('DF_RTOFS_DA_T100_SAB_deep.pkl')
DF_RTOFS_DA_T100_300_deep = pd.read_pickle('DF_RTOFS_DA_T100_300_SAB_deep.pkl')
DF_RTOFS_DA_PEA_deep = pd.read_pickle('DF_RTOFS_DA_PEA_SAB_deep.pkl')

DF_GOFS_temp_salt_deep = pd.read_pickle('DF_GOFS_temp_salt_SAB_deep.pkl')
DF_GOFS_MLD_deep = pd.read_pickle('DF_GOFS_MLD_SAB_deep.pkl')
DF_GOFS_OHC_deep = pd.read_pickle('DF_GOFS_OHC_SAB_deep.pkl')
DF_GOFS_T100_deep = pd.read_pickle('DF_GOFS_T100_SAB_deep.pkl')
DF_GOFS_T100_300_deep = pd.read_pickle('DF_GOFS_T100_300_SAB_deep.pkl')
DF_GOFS_PEA_deep = pd.read_pickle('DF_GOFS_PEA_SAB_deep.pkl')

'''

#################### Deep gliders ###############################
#%% Temperature statistics.
DF_RTOFS = DF_RTOFS_temp_salt_deep.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_temp_salt_deep.dropna()
DF_GOFS = DF_GOFS_temp_salt_deep.dropna()
...
DF_RTOFS = DF_RTOFS_MLD_deep.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_MLD_deep.dropna()
DF_GOFS = DF_GOFS_MLD_deep.dropna()
...
#%% OHC statistics
DF_RTOFS = DF_RTOFS_OHC_deep.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_OHC_deep.dropna()
DF_GOFS = DF_GOFS_OHC_deep.dropna()
...
#%% T100 statistics
DF_RTOFS = DF_RTOFS_T100_deep.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_T100_deep.dropna()
DF_GOFS = DF_GOFS_T100_deep.dropna()
...
#%% T100_300 statistics
DF_RTOFS = DF_RTOFS_T100_300_deep.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_T100_300_deep.dropna()
DF_GOFS = DF_GOFS_T100_300_deep.dropna()
...
#%% PEA statistics
DF_RTOFS = DF_RTOFS_PEA_deep.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_PEA_deep.dropna()
DF_GOFS = DF_GOFS_PEA_deep.dropna()
...
file = folder_fig + 'Taylor_norm_RTOFS_RTOFS_DA_GOFS_SAB_deep'
plt.savefig(file,bbox_inches = 'tight',pad_inches = 0.1)
...
file = folder_fig + 'Taylor_norm_RTOFS_RTOFS_DA_GOFS_SAB_shelf'
plt.savefig(file,bbox_inches = 'tight',pad_inches = 0.1)
