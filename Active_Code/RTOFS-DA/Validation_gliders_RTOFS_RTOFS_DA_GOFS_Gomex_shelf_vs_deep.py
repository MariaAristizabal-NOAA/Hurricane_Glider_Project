...
DF_RTOFS_temp_salt_shallow = pd.DataFrame()
DF_RTOFS_DA_temp_salt_shallow = pd.DataFrame()
DF_GOFS_temp_salt_shallow = pd.DataFrame()
DF_RTOFS_MLD_shallow = pd.DataFrame()
DF_RTOFS_DA_MLD_shallow = pd.DataFrame()
DF_GOFS_MLD_shallow = pd.DataFrame()
DF_RTOFS_OHC_shallow = pd.DataFrame()
DF_RTOFS_DA_OHC_shallow = pd.DataFrame()
DF_GOFS_OHC_shallow = pd.DataFrame()
DF_RTOFS_T100_shallow = pd.DataFrame()
DF_RTOFS_DA_T100_shallow = pd.DataFrame()
DF_GOFS_T100_shallow = pd.DataFrame()
DF_RTOFS_T100_300_shallow = pd.DataFrame()
DF_RTOFS_DA_T100_300_shallow = pd.DataFrame()
DF_GOFS_T100_300_shallow = pd.DataFrame()
...
for f,dataset_id in enumerate(gliders):
    ...
    if not empty_dataset:
        ...
        if np.logical_or(dataset_id.split('-')[0][0:2]=='ng',\
           np.logical_or(dataset_id.split('-')[0]=='Stommel',dataset_id.split('-')[0][0:2]=='SG')):
        ...
        if np.logical_or(np.logical_or(dataset_id.split('-')[0]=='mote',dataset_id.split('-')[0]=='usf'),\
           np.logical_or(dataset_id.split('-')[0]=='Sverdrup',dataset_id.split('-')[0]=='stella')):
            #%% Concatenate data frames
            DF_RTOFS_temp_salt_shallow = pd.concat([DF_RTOFS_temp_salt_shallow, df_RTOFS_temp_salt])
            DF_RTOFS_DA_temp_salt_shallow = pd.concat([DF_RTOFS_DA_temp_salt_shallow, df_RTOFS_DA_temp_salt])
            DF_GOFS_temp_salt_shallow = pd.concat([DF_GOFS_temp_salt_shallow, df_GOFS_temp_salt])
            DF_RTOFS_MLD_shallow = pd.concat([DF_RTOFS_MLD_shallow, df_RTOFS_MLD])
            DF_RTOFS_DA_MLD_shallow = pd.concat([DF_RTOFS_DA_MLD_shallow, df_RTOFS_DA_MLD])
            DF_GOFS_MLD_shallow = pd.concat([DF_GOFS_MLD_shallow, df_GOFS_MLD])
            DF_RTOFS_OHC_shallow = pd.concat([DF_RTOFS_OHC_shallow, df_RTOFS_OHC])
            DF_RTOFS_DA_OHC_shallow = pd.concat([DF_RTOFS_DA_OHC_shallow, df_RTOFS_DA_OHC])
            DF_GOFS_OHC_shallow = pd.concat([DF_GOFS_OHC_shallow, df_GOFS_OHC])
            DF_RTOFS_T100_shallow = pd.concat([DF_RTOFS_T100_shallow, df_RTOFS_T100])
            DF_RTOFS_DA_T100_shallow = pd.concat([DF_RTOFS_DA_T100_shallow, df_RTOFS_DA_T100])
            DF_GOFS_T100_shallow = pd.concat([DF_GOFS_T100_shallow, df_GOFS_T100])
            DF_RTOFS_T100_300_shallow = pd.concat([DF_RTOFS_T100_300_shallow, df_RTOFS_T100_300])
            DF_RTOFS_DA_T100_300_shallow = pd.concat([DF_RTOFS_DA_T100_300_shallow, df_RTOFS_DA_T100_300])
            DF_GOFS_T100_300_shallow = pd.concat([DF_GOFS_T100_300_shallow, df_GOFS_T100_300])

#%% Save all data frames
DF_RTOFS_temp_salt_deep.to_pickle('DF_RTOFS_temp_salt_GoMex_deep.pkl')
DF_RTOFS_MLD_deep.to_pickle('DF_RTOFS_MLD_GoMex_deep.pkl')
DF_RTOFS_OHC_deep.to_pickle('DF_RTOFS_OHC_GoMex_deep.pkl')
DF_RTOFS_T100_deep.to_pickle('DF_RTOFS_T100_GoMex_deep.pkl')
DF_RTOFS_T100_300_deep.to_pickle('DF_RTOFS_T100_300_GoMex_deep.pkl')

DF_RTOFS_DA_temp_salt_deep.to_pickle('DF_RTOFS_DA_temp_salt_GoMex_deep.pkl')
DF_RTOFS_DA_MLD_deep.to_pickle('DF_RTOFS_DA_MLD_GoMex_deep.pkl')
DF_RTOFS_DA_OHC_deep.to_pickle('DF_RTOFS_DA_OHC_GoMex_deep.pkl')
DF_RTOFS_DA_T100_deep.to_pickle('DF_RTOFS_DA_T100_GoMex_deep.pkl')
DF_RTOFS_DA_T100_300_deep.to_pickle('DF_RTOFS_DA_T100_300_GoMex_deep.pkl')

DF_GOFS_temp_salt_deep.to_pickle('DF_GOFS_temp_salt_GoMex_deep.pkl')
DF_GOFS_MLD_deep.to_pickle('DF_GOFS_MLD_GoMex_deep.pkl')
DF_GOFS_OHC_deep.to_pickle('DF_GOFS_OHC_GoMex_deep.pkl')
DF_GOFS_T100_deep.to_pickle('DF_GOFS_T100_GoMex_deep.pkl')
DF_GOFS_T100_300_deep.to_pickle('DF_GOFS_T100_300_GoMex_deep.pkl')

#%% Save all data frames
DF_RTOFS_temp_salt_shallow.to_pickle('DF_RTOFS_temp_salt_GoMex_shallow.pkl')
DF_RTOFS_MLD_shallow.to_pickle('DF_RTOFS_MLD_GoMex_shallow.pkl')
DF_RTOFS_OHC_shallow.to_pickle('DF_RTOFS_OHC_GoMex_shallow.pkl')
DF_RTOFS_T100_shallow.to_pickle('DF_RTOFS_T100_GoMex_shallow.pkl')
DF_RTOFS_T100_300_shallow.to_pickle('DF_RTOFS_T100_300_GoMex_shallow.pkl')

DF_RTOFS_DA_temp_salt_shallow.to_pickle('DF_RTOFS_DA_temp_salt_GoMex_shallow.pkl')
DF_RTOFS_DA_MLD_shallow.to_pickle('DF_RTOFS_DA_MLD_GoMex_shallow.pkl')
DF_RTOFS_DA_OHC_shallow.to_pickle('DF_RTOFS_DA_OHC_GoMex_shallow.pkl')
DF_RTOFS_DA_T100_shallow.to_pickle('DF_RTOFS_DA_T100_GoMex_shallow.pkl')
DF_RTOFS_DA_T100_300_shallow.to_pickle('DF_RTOFS_DA_T100_300_GoMex_shallow.pkl')

DF_GOFS_temp_salt_shallow.to_pickle('DF_GOFS_temp_salt_GoMex_shallow.pkl')
DF_GOFS_MLD_shallow.to_pickle('DF_GOFS_MLD_GoMex_shallow.pkl')
DF_GOFS_OHC_shallow.to_pickle('DF_GOFS_OHC_GoMex_shallow.pkl')
DF_GOFS_T100_shallow.to_pickle('DF_GOFS_T100_GoMex_shallow.pkl')
DF_GOFS_T100_300_shallow.to_pickle('DF_GOFS_T100_300_GoMex_shallow.pkl')

#%% Load all data frames
# Deep gliders
DF_RTOFS_temp_salt_deep = pd.read_pickle('DF_RTOFS_temp_salt_GoMex_deep.pkl')
DF_RTOFS_MLD_deep = pd.read_pickle('DF_RTOFS_MLD_GoMex_deep.pkl')
DF_RTOFS_OHC_deep = pd.read_pickle('DF_RTOFS_OHC_GoMex_deep.pkl')
DF_RTOFS_T100_deep = pd.read_pickle('DF_RTOFS_T100_GoMex_deep.pkl')
DF_RTOFS_T100_300_deep = pd.read_pickle('DF_RTOFS_T100_300_GoMex_deep.pkl')

DF_RTOFS_DA_temp_salt_deep = pd.read_pickle('DF_RTOFS_DA_temp_salt_GoMex_deep.pkl')
DF_RTOFS_DA_MLD_deep = pd.read_pickle('DF_RTOFS_DA_MLD_GoMex_deep.pkl')
DF_RTOFS_DA_OHC_deep = pd.read_pickle('DF_RTOFS_DA_OHC_GoMex_deep.pkl')
DF_RTOFS_DA_T100_deep = pd.read_pickle('DF_RTOFS_DA_T100_GoMex_deep.pkl')
DF_RTOFS_DA_T100_300_deep = pd.read_pickle('DF_RTOFS_DA_T100_300_GoMex_deep.pkl')

DF_GOFS_temp_salt_deep = pd.read_pickle('DF_GOFS_temp_salt_GoMex_deep.pkl')
DF_GOFS_MLD_deep = pd.read_pickle('DF_GOFS_MLD_GoMex_deep.pkl')
DF_GOFS_OHC_deep = pd.read_pickle('DF_GOFS_OHC_GoMex_deep.pkl')
DF_GOFS_T100_deep = pd.read_pickle('DF_GOFS_T100_GoMex_deep.pkl')
DF_GOFS_T100_300_deep = pd.read_pickle('DF_GOFS_T100_300_GoMex_deep.pkl')

# Shallow gliders
DF_RTOFS_temp_salt_shallow = pd.read_pickle('DF_RTOFS_temp_salt_GoMex_shallow.pkl')
DF_RTOFS_MLD_shallow = pd.read_pickle('DF_RTOFS_MLD_GoMex_shallow.pkl')
DF_RTOFS_OHC_shallow = pd.read_pickle('DF_RTOFS_OHC_GoMex_shallow.pkl')
DF_RTOFS_T100_shallow = pd.read_pickle('DF_RTOFS_T100_GoMex_shallow.pkl')
DF_RTOFS_T100_300_shallow = pd.read_pickle('DF_RTOFS_DA_T100_300_GoMex_shallow.pkl')

DF_RTOFS_DA_temp_salt_shallow = pd.read_pickle('DF_RTOFS_DA_temp_salt_GoMex_shallow.pkl')
DF_RTOFS_DA_MLD_shallow = pd.read_pickle('DF_RTOFS_DA_MLD_GoMex_shallow.pkl')
DF_RTOFS_DA_OHC_shallow = pd.read_pickle('DF_RTOFS_DA_OHC_GoMex_shallow.pkl')
DF_RTOFS_DA_T100_shallow = pd.read_pickle('DF_RTOFS_DA_T100_GoMex_shallow.pkl')
DF_RTOFS_DA_T100_300_shallow = pd.read_pickle('DF_RTOFS_DA_T100_300_GoMex_shallow.pkl')

DF_GOFS_temp_salt_shallow = pd.read_pickle('DF_GOFS_temp_salt_GoMex_shallow.pkl')
DF_GOFS_MLD_shallow = pd.read_pickle('DF_GOFS_MLD_GoMex_shallow.pkl')
DF_GOFS_OHC_shallow = pd.read_pickle('DF_GOFS_OHC_GoMex_shallow.pkl')
DF_GOFS_T100_shallow = pd.read_pickle('DF_GOFS_T100_GoMex_shallow.pkl')
DF_GOFS_T100_300_shallow = pd.read_pickle('DF_GOFS_T100_300_GoMex_shallow.pkl')
...
file = folder_fig + 'Taylor_norm_RTOFS_RTOFS_DA_GOFS_GoMex_deep'
plt.savefig(file,bbox_inches = 'tight',pad_inches = 0.1)

#################### Shallow gliders ###############################
#%% Temperature statistics.
DF_RTOFS = DF_RTOFS_temp_salt_shallow.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_temp_salt_shallow.dropna()
DF_GOFS = DF_GOFS_temp_salt_shallow.dropna()
...
#%% Mixed layer statistics Temperature.
DF_RTOFS = DF_RTOFS_MLD_shallow.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_MLD_shallow.dropna()
DF_GOFS = DF_GOFS_MLD_shallow.dropna()
...
#%% OHC statistics
DF_RTOFS = DF_RTOFS_OHC_shallow.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_OHC_shallow.dropna()
DF_GOFS = DF_GOFS_OHC_shallow.dropna()
...
#%% T100 statistics
'''
DF_RTOFS = DF_RTOFS_T100_shallow.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_T100_shallow.dropna()
DF_GOFS = DF_GOFS_T100_shallow.dropna()
...
#%% T100_300 statistics
'''
DF_RTOFS = DF_RTOFS_T100_300_shallow.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_T100_300_shallow.dropna()
DF_GOFS = DF_GOFS_T100_300_shallow.dropna()
...
file = folder_fig + 'Taylor_norm_RTOFS_RTOFS_DA_GOFS_GoMex_shallow'
plt.savefig(file,bbox_inches = 'tight',pad_inches = 0.1)
