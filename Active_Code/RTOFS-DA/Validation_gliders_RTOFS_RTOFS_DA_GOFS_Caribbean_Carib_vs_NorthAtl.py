...
for id in gliders:
    ...
    if id.split('-')[0][0:2] == 'SG':
        if np.nanmean(df['latitude (degrees_north)']) > 17.5:
            marker = markers[1]
            color = colors[1]
        else:
            marker = markers[3]
...
file = folder_fig + 'Map_Caribbean_20200619_20201025_Carib_NA'
...
#%%
DF_RTOFS_temp_salt_Carib = pd.DataFrame()
DF_RTOFS_DA_temp_salt_Carib = pd.DataFrame()
DF_GOFS_temp_salt_Carib = pd.DataFrame()
DF_RTOFS_MLD_Carib = pd.DataFrame()
DF_RTOFS_DA_MLD_Carib = pd.DataFrame()
DF_GOFS_MLD_Carib = pd.DataFrame()
DF_RTOFS_OHC_Carib = pd.DataFrame()
DF_RTOFS_DA_OHC_Carib = pd.DataFrame()
DF_GOFS_OHC_Carib = pd.DataFrame()
DF_RTOFS_T100_Carib = pd.DataFrame()
DF_RTOFS_DA_T100_Carib = pd.DataFrame()
DF_GOFS_T100_Carib = pd.DataFrame()
DF_RTOFS_T100_300_Carib = pd.DataFrame()
DF_RTOFS_DA_T100_300_Carib = pd.DataFrame()
DF_GOFS_T100_300_Carib = pd.DataFrame()
DF_RTOFS_PEA_Carib = pd.DataFrame()
DF_RTOFS_DA_PEA_Carib = pd.DataFrame()
DF_GOFS_PEA_Carib = pd.DataFrame()

DF_RTOFS_temp_salt_NA = pd.DataFrame()
DF_RTOFS_DA_temp_salt_NA = pd.DataFrame()
DF_GOFS_temp_salt_NA = pd.DataFrame()
DF_RTOFS_MLD_NA = pd.DataFrame()
DF_RTOFS_DA_MLD_NA = pd.DataFrame()
DF_GOFS_MLD_NA = pd.DataFrame()
DF_RTOFS_OHC_NA = pd.DataFrame()
DF_RTOFS_DA_OHC_NA = pd.DataFrame()
DF_GOFS_OHC_NA = pd.DataFrame()
DF_RTOFS_T100_NA = pd.DataFrame()
DF_RTOFS_DA_T100_NA = pd.DataFrame()
DF_GOFS_T100_NA = pd.DataFrame()
DF_RTOFS_T100_300_NA = pd.DataFrame()
DF_RTOFS_DA_T100_300_NA = pd.DataFrame()
DF_GOFS_T100_300_NA = pd.DataFrame()
DF_RTOFS_PEA_NA = pd.DataFrame()
DF_RTOFS_DA_PEA_NA = pd.DataFrame()
DF_GOFS_PEA_NA = pd.DataFrame()
...
for f,dataset_id in enumerate(gliders):
    ...
    if not empty_dataset:
        ...
        if np.logical_or.reduce([dataset_id.split('-')[0][0:2]=='ng',dataset_id.split('-')[0][0:2]=='ru',\
                                 dataset_id.split('-')[0]=='SG649',dataset_id.split('-')[0]=='SG663',\
                                 dataset_id.split('-')[0]=='SG664',dataset_id.split('-')[0]=='SG669',\
                                 dataset_id.split('-')[0]=='SG610']):
            print('Caribbean glider: '+dataset_id)

            #%% Concatenate data frames
            DF_RTOFS_temp_salt_Carib = pd.concat([DF_RTOFS_temp_salt_Carib, df_RTOFS_temp_salt])
            DF_RTOFS_DA_temp_salt_Carib = pd.concat([DF_RTOFS_DA_temp_salt_Carib, df_RTOFS_DA_temp_salt])
            DF_GOFS_temp_salt_Carib = pd.concat([DF_GOFS_temp_salt_Carib, df_GOFS_temp_salt])
            DF_RTOFS_MLD_Carib = pd.concat([DF_RTOFS_MLD_Carib, df_RTOFS_MLD])
            DF_RTOFS_DA_MLD_Carib = pd.concat([DF_RTOFS_DA_MLD_Carib, df_RTOFS_DA_MLD])
            DF_GOFS_MLD_Carib = pd.concat([DF_GOFS_MLD_Carib, df_GOFS_MLD])
            DF_RTOFS_OHC_Carib = pd.concat([DF_RTOFS_OHC_Carib, df_RTOFS_OHC])
            DF_RTOFS_DA_OHC_Carib = pd.concat([DF_RTOFS_DA_OHC_Carib, df_RTOFS_DA_OHC])
            DF_GOFS_OHC_Carib = pd.concat([DF_GOFS_OHC_Carib, df_GOFS_OHC])
            DF_RTOFS_T100_Carib = pd.concat([DF_RTOFS_T100_Carib, df_RTOFS_T100])
            DF_RTOFS_DA_T100_Carib = pd.concat([DF_RTOFS_DA_T100_Carib, df_RTOFS_DA_T100])
            DF_GOFS_T100_Carib = pd.concat([DF_GOFS_T100_Carib, df_GOFS_T100])
            DF_RTOFS_T100_300_Carib = pd.concat([DF_RTOFS_T100_300_Carib, df_RTOFS_T100_300])
            DF_RTOFS_DA_T100_300_Carib = pd.concat([DF_RTOFS_DA_T100_300_Carib, df_RTOFS_DA_T100_300])
            DF_GOFS_T100_300_Carib = pd.concat([DF_GOFS_T100_300_Carib, df_GOFS_T100_300])

        if np.logical_or.reduce([dataset_id.split('-')[0]=='SG609',dataset_id.split('-')[0]=='SG630',\
                                 dataset_id.split('-')[0]=='SG635',dataset_id.split('-')[0][0:2]=='SG665']):
            print('North Atlantic glider: '+dataset_id)
            #%% Concatenate data frames
            DF_RTOFS_temp_salt_NA = pd.concat([DF_RTOFS_temp_salt_NA, df_RTOFS_temp_salt])
            DF_RTOFS_DA_temp_salt_NA = pd.concat([DF_RTOFS_DA_temp_salt_NA, df_RTOFS_DA_temp_salt])
            DF_GOFS_temp_salt_NA = pd.concat([DF_GOFS_temp_salt_NA, df_GOFS_temp_salt])
            DF_RTOFS_MLD_NA = pd.concat([DF_RTOFS_MLD_NA, df_RTOFS_MLD])
            DF_RTOFS_DA_MLD_NA = pd.concat([DF_RTOFS_DA_MLD_NA, df_RTOFS_DA_MLD])
            DF_GOFS_MLD_NA = pd.concat([DF_GOFS_MLD_NA, df_GOFS_MLD])
            DF_RTOFS_OHC_NA = pd.concat([DF_RTOFS_OHC_NA, df_RTOFS_OHC])
            DF_RTOFS_DA_OHC_NA = pd.concat([DF_RTOFS_DA_OHC_NA, df_RTOFS_DA_OHC])
            DF_GOFS_OHC_NA = pd.concat([DF_GOFS_OHC_NA, df_GOFS_OHC])
            DF_RTOFS_T100_NA = pd.concat([DF_RTOFS_T100_NA, df_RTOFS_T100])
            DF_RTOFS_DA_T100_NA = pd.concat([DF_RTOFS_DA_T100_NA, df_RTOFS_DA_T100])
            DF_GOFS_T100_NA = pd.concat([DF_GOFS_T100_NA, df_GOFS_T100])
            DF_RTOFS_T100_300_NA = pd.concat([DF_RTOFS_T100_300_NA, df_RTOFS_T100_300])
            DF_RTOFS_DA_T100_300_NA = pd.concat([DF_RTOFS_DA_T100_300_NA, df_RTOFS_DA_T100_300])
            DF_GOFS_T100_300_NA = pd.concat([DF_GOFS_T100_300_NA, df_GOFS_T100_300])

#%% Save all data frames
DF_RTOFS_temp_salt_Carib.to_pickle('DF_RTOFS_temp_salt_Caribbean_Carib.pkl')
DF_RTOFS_MLD_Carib.to_pickle('DF_RTOFS_MLD_Caribbean_Carib.pkl')
DF_RTOFS_OHC_Carib.to_pickle('DF_RTOFS_OHC_Caribbean_Carib.pkl')
DF_RTOFS_T100_Carib.to_pickle('DF_RTOFS_T100_Caribbean_Carib.pkl')
DF_RTOFS_T100_300_Carib.to_pickle('DF_RTOFS_T100_300_Caribbean_Carib.pkl')

DF_RTOFS_DA_temp_salt_Carib.to_pickle('DF_RTOFS_DA_temp_salt_Caribbean_Carib.pkl')
DF_RTOFS_DA_MLD_Carib.to_pickle('DF_RTOFS_DA_MLD_Caribbean_Carib.pkl')
DF_RTOFS_DA_OHC_Carib.to_pickle('DF_RTOFS_DA_OHC_Caribbean_Carib.pkl')
DF_RTOFS_DA_T100_Carib.to_pickle('DF_RTOFS_DA_T100_Caribbean_Carib.pkl')
DF_RTOFS_DA_T100_300_Carib.to_pickle('DF_RTOFS_DA_T100_300_Caribbean_Carib.pkl')

DF_GOFS_temp_salt_Carib.to_pickle('DF_GOFS_temp_salt_Caribbean_Carib.pkl')
DF_GOFS_MLD_Carib.to_pickle('DF_GOFS_MLD_Caribbean_Carib.pkl')
DF_GOFS_OHC_Carib.to_pickle('DF_GOFS_OHC_Caribbean_Carib.pkl')
DF_GOFS_T100_Carib.to_pickle('DF_GOFS_T100_Caribbean_Carib.pkl')
DF_GOFS_T100_300_Carib.to_pickle('DF_GOFS_T100_300_Caribbean_Carib.pkl')

#%% Save all data frames
DF_RTOFS_temp_salt_NA.to_pickle('DF_RTOFS_temp_salt_Caribbean_NA.pkl')
DF_RTOFS_MLD_NA.to_pickle('DF_RTOFS_MLD_Caribbean_NA.pkl')
DF_RTOFS_OHC_NA.to_pickle('DF_RTOFS_OHC_Caribbean_NA.pkl')
DF_RTOFS_T100_NA.to_pickle('DF_RTOFS_T100_Caribbean_NA.pkl')
DF_RTOFS_T100_300_NA.to_pickle('DF_RTOFS_T100_300_Caribbean_NA.pkl')

DF_RTOFS_DA_temp_salt_NA.to_pickle('DF_RTOFS_DA_temp_salt_Caribbean_NA.pkl')
DF_RTOFS_DA_MLD_NA.to_pickle('DF_RTOFS_DA_MLD_Caribbean_NA.pkl')
DF_RTOFS_DA_OHC_NA.to_pickle('DF_RTOFS_DA_OHC_Caribbean_NA.pkl')
DF_RTOFS_DA_T100_NA.to_pickle('DF_RTOFS_DA_T100_Caribbean_NA.pkl')
DF_RTOFS_DA_T100_300_NA.to_pickle('DF_RTOFS_DA_T100_300_Caribbean_NA.pkl')

DF_GOFS_temp_salt_NA.to_pickle('DF_GOFS_temp_salt_Caribbean_NA.pkl')
DF_GOFS_MLD_NA.to_pickle('DF_GOFS_MLD_Caribbean_NA.pkl')
DF_GOFS_OHC_NA.to_pickle('DF_GOFS_OHC_Caribbean_NA.pkl')
DF_GOFS_T100_NA.to_pickle('DF_GOFS_T100_Caribbean_NA.pkl')
DF_GOFS_T100_300_NA.to_pickle('DF_GOFS_T100_300_Caribbean_Carib_NA.pkl')


#%% Load all data frames
'''
DF_RTOFS_temp_salt_Carib = pd.read_pickle('DF_RTOFS_temp_salt_Caribbean_Carib.pkl')
DF_RTOFS_MLD_Carib = pd.read_pickle('DF_RTOFS_MLD_Caribbean_Carib.pkl')
DF_RTOFS_OHC_Carib = pd.read_pickle('DF_RTOFS_OHC_Caribbean_Carib.pkl')
DF_RTOFS_T100_Carib = pd.read_pickle('DF_RTOFS_T100_Caribbean_Carib.pkl')
DF_RTOFS_T100_300_Carib = pd.read_pickle('DF_RTOFS_T100_300_Caribbean_Carib.pkl')

DF_RTOFS_DA_temp_salt_Carib = pd.read_pickle('DF_RTOFS_DA_temp_salt_Caribbean_Carib.pkl')
DF_RTOFS_DA_MLD_Carib = pd.read_pickle('DF_RTOFS_DA_MLD_Caribbean_Carib.pkl')
DF_RTOFS_DA_OHC_Carib = pd.read_pickle('DF_RTOFS_DA_OHC_Caribbean_Carib.pkl')
DF_RTOFS_DA_T100_Carib = pd.read_pickle('DF_RTOFS_DA_T100_Caribbean_Carib.pkl')
DF_RTOFS_DA_T100_300_Carib = pd.read_pickle('DF_RTOFS_DA_T100_300_Caribbean_Carib.pkl')

DF_GOFS_temp_salt_Carib = pd.read_pickle('DF_GOFS_temp_salt_Caribbean_Carib.pkl')
DF_GOFS_MLD_Carib = pd.read_pickle('DF_GOFS_MLD_Caribbean_Carib.pkl')
DF_GOFS_OHC_Carib = pd.read_pickle('DF_GOFS_OHC_Caribbean_Carib.pkl')
DF_GOFS_T100_Carib = pd.read_pickle('DF_GOFS_T100_Caribbean_Carib.pkl')
DF_GOFS_T100_300_Carib = pd.read_pickle('DF_GOFS_T100_300_Caribbean_Carib.pkl')

DF_RTOFS_temp_salt_NA = pd.read_pickle('DF_RTOFS_temp_salt_Caribbean_NA.pkl')
DF_RTOFS_MLD_NA = pd.read_pickle('DF_RTOFS_MLD_Caribbean_NA.pkl')
DF_RTOFS_OHC_NA = pd.read_pickle('DF_RTOFS_OHC_Caribbean_NA.pkl')
DF_RTOFS_T100_NA = pd.read_pickle('DF_RTOFS_T100_Caribbean_NA.pkl')
DF_RTOFS_T100_300_NA = pd.read_pickle('DF_RTOFS_T100_300_Caribbean_NA.pkl')

DF_RTOFS_DA_temp_salt_NA = pd.read_pickle('DF_RTOFS_DA_temp_salt_Caribbean_NA.pkl')
DF_RTOFS_DA_MLD_NA = pd.read_pickle('DF_RTOFS_DA_MLD_Caribbean_NA.pkl')
DF_RTOFS_DA_OHC_NA = pd.read_pickle('DF_RTOFS_DA_OHC_Caribbean_NA.pkl')
DF_RTOFS_DA_T100_NA = pd.read_pickle('DF_RTOFS_DA_T100_Caribbean_NA.pkl')
DF_RTOFS_DA_T100_300_NA = pd.read_pickle('DF_RTOFS_DA_T100_300_Caribbean_NA.pkl')

DF_GOFS_temp_salt_NA = pd.read_pickle('DF_GOFS_temp_salt_Caribbean_NA.pkl')
DF_GOFS_MLD_NA = pd.read_pickle('DF_GOFS_MLD_Caribbean_NA.pkl')
DF_GOFS_OHC_NA = pd.read_pickle('DF_GOFS_OHC_Caribbean_NA.pkl')
DF_GOFS_T100_NA = pd.read_pickle('DF_GOFS_T100_Caribbean_NA.pkl')
DF_GOFS_T100_300_NA = pd.read_pickle('DF_GOFS_T100_300_Caribbean_NA.pkl')

'''

#%% Temperature statistics Carib
DF_RTOFS = DF_RTOFS_temp_salt_Carib.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_temp_salt_Carib.dropna()
DF_GOFS = DF_GOFS_temp_salt_Carib.dropna()
...
DF_RTOFS = DF_RTOFS_MLD_Carib.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_MLD_Carib.dropna()
DF_GOFS = DF_GOFS_MLD_Carib.dropna()
...
#%% OHC statistics
DF_RTOFS = DF_RTOFS_OHC_Carib.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_OHC_Carib.dropna()
DF_GOFS = DF_GOFS_OHC_Carib.dropna()
...
#%% T100 statistics
DF_RTOFS = DF_RTOFS_T100_Carib.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_T100_Carib.dropna()
DF_GOFS = DF_GOFS_T100_Carib.dropna()
...
#%% T100_300 statistics
DF_RTOFS = DF_RTOFS_T100_300_Carib.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_T100_300_Carib.dropna()
DF_GOFS = DF_GOFS_T100_300_Carib.dropna()
...
file = folder_fig + 'Taylor_norm_RTOFS_RTOFS_DA_GOFS_Caribbean_Carib'
plt.savefig(file,bbox_inches = 'tight',pad_inches = 0.1)

#########################################################################################

#%% Temperature statistics NA
DF_RTOFS = DF_RTOFS_temp_salt_NA.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_temp_salt_NA.dropna()
DF_GOFS = DF_GOFS_temp_salt_NA.dropna()
...
#%% Mixed layer statistics Temperature.
DF_RTOFS = DF_RTOFS_MLD_NA.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_MLD_NA.dropna()
DF_GOFS = DF_GOFS_MLD_NA.dropna()
...
#%% OHC statistics
DF_RTOFS = DF_RTOFS_OHC_NA.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_OHC_NA.dropna()
DF_GOFS = DF_GOFS_OHC_NA.dropna()
...
#%% T100 statistics
DF_RTOFS = DF_RTOFS_T100_NA.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_T100_NA.dropna()
DF_GOFS = DF_GOFS_T100_NA.dropna()
...
#%% T100_300 statistics
DF_RTOFS = DF_RTOFS_T100_300_NA.dropna()
DF_RTOFS_DA = DF_RTOFS_DA_T100_300_NA.dropna()
DF_GOFS = DF_GOFS_T100_300_NA.dropna()
...
file = folder_fig + 'Taylor_norm_RTOFS_RTOFS_DA_GOFS_Caribbean_NA'
plt.savefig(file,bbox_inches = 'tight',pad_inches = 0.1)
